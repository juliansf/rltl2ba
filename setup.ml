...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0df3e0a40fa56119a9fc7476d6b74318) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["cudd_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-I"; "lib/cudd/include"])];
                      bs_cclib =
                        [
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "É°±\131Iô\158è,­\156\002¬ß÷\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
