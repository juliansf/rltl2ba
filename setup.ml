...
(* OASIS_START *)
(* DO NOT EDIT (digest: cb2e0e75cbdb3666131c4698bee44c6f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$syntax_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     doc = [("api-rltl", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("api-rltl", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("syntax",
     ...
     package =
       {
          ...
          findlib_version = Some (OASISVersion.VGreaterEqual "1.2.6");
          name = "rltl2ba";
          version = "0.1.0";
          license =
          ...
          homepage = Some "http://software.imdea.org/~julian/rltl2ba";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["cudd"])))];
               post_command = [(OASISExpr.EBool true, None)];
               };
          ...
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("make", ["cudddistclean"])))];
               };
          files_ab = [];
          sections =
            [
               Flag
                 ({
                     ...
                     },
                   {
                      flag_description =
                        Some
                          "Install rltl libraries, for using inside Ocaml programs";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Misc"; "Config"; "Clflags"; "Warnings"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "cudd"; InternalLibrary "utils"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Expgen_private"; "Manager"; "Node"; "Printexpr"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/parsing";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "utils"];
                      bs_build_tools =
                        [
                   ...
                   {
                      lib_modules = ["Location"; "Syntaxerr"];
                      lib_pack = false;
                      lib_internal_modules = ["Parser"; "Lexer"; "Printast"];
                      lib_findlib_parent = Some "rltl";
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/typing";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "parsing"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/translator";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "rltl"; InternalLibrary "typing"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Translate"];
                      lib_pack = false;
                      lib_internal_modules = ["Entry"; "Operpredef"];
                      lib_findlib_parent = Some "rltl";
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "cudd";
                           InternalLibrary "utils";
                           InternalLibrary "rltl";
                           InternalLibrary "parsing";
                           InternalLibrary "typing";
                           InternalLibrary "translator"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "driver/main.ml"; });
               Doc
                 ({
                     cs_name = "api-rltl";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/rltl";
                      doc_title = "API reference for RltlLib";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "oUnit";
                           FindlibPackage ("util", None);
                           InternalLibrary "driver";
                           InternalLibrary "parsing"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                   ...
                   {exec_custom = false; exec_main_is = "syntax_test.ml"; });
               Test
                 ({
                     cs_name = "syntax";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      test_working_directory = Some "test/syntax";
                      test_run =
                        [
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/juliansf/rltl2ba.git";
                      src_repo_browser =
                        Some "https://github.com/juliansf/rltl2ba";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "F Iu3ð\029pöHq%£ê#r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
